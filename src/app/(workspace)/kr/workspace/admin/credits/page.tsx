...
import CreditsAuditClient from "./credits-audit-client";

export default async function AdminCreditsAuditPage() {
  ...
  if (authError || !user) {
    redirect("/kr/login?next=/kr/workspace/admin/credits");
  }
