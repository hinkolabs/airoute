                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <AffiliateLinkButton
                        ...
                        toolSlug={tool.slug}
                        className="inline-flex items-center gap-2 rounded-lg border border-primary/40 bg-primary/10 px-4 py-2 text-sm font-semibold text-primary transition hover:border-primary hover:bg-primary/15"
                      >
