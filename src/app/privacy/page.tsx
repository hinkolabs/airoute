    ...
    <div className="min-h-screen bg-background px-4 py-6 pb-24">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <section className="space-y-4">
          ...
          <h3 className="text-lg font-semibold text-foreground">A. Personal Data</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="text-lg font-semibold text-foreground mt-4">B. Usage Data</h3>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">3. How We Use Google User Data (Important)</h2>
          <p className="text-muted-foreground">
